  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        pixel: "bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:from-purple-700 hover:to-blue-700 border-4 border-purple-400 rounded-xl font-game text-xl px-6 py-3 shadow-lg hover:shadow-purple-500/50 hover:scale-105 active:scale-95",
        pixelDisable: "bg-zinc-700 text-zinc-400 border-4 border-zinc-600 rounded-xl font-game text-xl px-6 py-3 cursor-not-allowed",
      },
      size: {
